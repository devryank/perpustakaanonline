...
?>
	...
	<a href="books.php" class="btn btn-primary">Lanjut Belanja</a>
<?php
	} else {
		echo "<p class=\"text-warning\">Keranjang Anda kosong! Pastikan Anda menambahkan beberapa buku di dalamnya!!</p>";
	}
