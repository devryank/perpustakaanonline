<?php
	...
	if(isset($_POST['add'])){
		...
		if(!$findResult){
			...
			if(!$insertResult){
				echo "Tidak bisa menambah penerbit baru " . mysqli_error($conn);
				exit;
			}
		...
		if(!$result){
			echo "Tidak bisa menambah buku baru " . mysqli_error($conn);
			exit;
		} else {
...
?>
	<form method="post" action="admin_add.php" enctype="multipart/form-data">
		...
		<input type="submit" name="add" value="Tambah Buku Baru" class="btn btn-primary">
